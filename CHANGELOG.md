...
- Quality gates for traceability, risk coverage, consistency, and anti-shallow review.
- `scaffold_docs_pack.py` helper for creating docs-pack skeletons.
- GitHub README, MIT license, version file, and changelog.
